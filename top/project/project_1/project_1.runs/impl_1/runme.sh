...
HD_PWD='/home/users/matsuda/project/Autonomous_Vehicle_Driving/top/project/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alltop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alltop.tcl -notrace
