...
HD_PWD='/home/users/matsuda/project/Autonomous_Vehicle_Driving/top/project/project_1/project_1.runs/pspl_comm_pspl_comm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pspl_comm_pspl_comm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pspl_comm_pspl_comm_0_0.tcl
