...
HD_PWD='/home/users/matsuda/project/Autonomous_Vehicle_Driving/top/project/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alltop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alltop.tcl
