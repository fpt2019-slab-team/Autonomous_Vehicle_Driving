...
HD_PWD='/home/users/matsuda/project/Autonomous_Vehicle_Driving/top/project/project_1/project_1.runs/pspl_comm_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pspl_comm_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pspl_comm_processing_system7_0_1.tcl
