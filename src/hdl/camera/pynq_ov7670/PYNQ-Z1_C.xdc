...
create_clock -period 40.000 -name cam_pclk_pin -waveform {0.000 20.000} -add [get_ports cam0_PCLK]
#create_clock -period 40.000 -name cam_pclk_pin -waveform {0.000 20.000} -add [get_ports cam1_PCLK]
...
##ChipKit Digital I/O Low ## 2nd camera
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports {cam1_D[0]}]; #IO_L4P_T0_34 Sch=ck_io[0]
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports {cam1_D[1]}]; #IO_L2N_T0_34 Sch=ck_io[1]
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports {cam1_D[2]}]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=ck_io[2]
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports {cam1_D[3]}]; #IO_L3N_T0_DQS_34 Sch=ck_io[3]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports {cam1_D[4]}]; #IO_L10P_T1_34 Sch=ck_io[4]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports {cam1_D[5]}]; #IO_L5N_T0_34 Sch=ck_io[5]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports {cam1_D[6]}]; #IO_L19P_T3_34 Sch=ck_io[6]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports {cam1_D[7]}]; #IO_L9N_T1_DQS_34 Sch=ck_io[7]

set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports cam1_PCLK]; #IO_L21P_T3_DQS_34 Sch=ck_io[8]
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports cam1_VSYNC]; #IO_L21N_T3_DQS_34 Sch=ck_io[9]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports cam1_HREF]; #IO_L9P_T1_DQS_34 Sch=ck_io[10]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports cam1_SIOD]; #IO_L19N_T3_VREF_34 Sch=ck_io[11]
...
#set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports cam_PWDN]
#set_property -dict {PACKAGE_PIN V5 IOSTANDARD LVCMOS33} [get_ports cam_XCLK]
#set_property -dict {PACKAGE_PIN V6 IOSTANDARD LVCMOS33} [get_ports cam_RESET]
#set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports cam_SIOC]
#set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS33} [get_ports cam_SIOD]
#set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports cam0_PCLK]
#set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports cam0_VSYNC]
#set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports cam0_HREF]

#set_property -dict {PACKAGE_PIN W10 IOSTANDARD LVCMOS33} [get_ports {cam0_D[0]}]
#set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVCMOS33} [get_ports {cam0_D[1]}]
#set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVCMOS33} [get_ports {cam0_D[2]}]
#set_property -dict {PACKAGE_PIN Y7 IOSTANDARD LVCMOS33} [get_ports {cam0_D[3]}]
#set_property -dict {PACKAGE_PIN W8 IOSTANDARD LVCMOS33} [get_ports {cam0_D[4]}]
#set_property -dict {PACKAGE_PIN Y8 IOSTANDARD LVCMOS33} [get_ports {cam0_D[5]}]
#set_property -dict {PACKAGE_PIN W9 IOSTANDARD LVCMOS33} [get_ports {cam0_D[6]}]
#set_property -dict {PACKAGE_PIN Y9 IOSTANDARD LVCMOS33} [get_ports {cam0_D[7]}]

set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports {cam0_D[0]}]
set_property -dict {PACKAGE_PIN V5 IOSTANDARD LVCMOS33} [get_ports {cam0_D[1]}]
set_property -dict {PACKAGE_PIN V6 IOSTANDARD LVCMOS33} [get_ports {cam0_D[2]}]
set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports {cam0_D[3]}]
set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS33} [get_ports {cam0_D[4]}]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports {cam0_D[5]}]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports {cam0_D[6]}]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {cam0_D[7]}]

set_property -dict {PACKAGE_PIN W10 IOSTANDARD LVCMOS33} [get_ports cam0_PCLK]
set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVCMOS33} [get_ports cam0_VSYNC]
set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVCMOS33} [get_ports cam0_HREF]
set_property -dict {PACKAGE_PIN Y7 IOSTANDARD LVCMOS33} [get_ports cam0_SIOD]

set_property -dict {PACKAGE_PIN W8 IOSTANDARD LVCMOS33} [get_ports cam_PWDN]
set_property -dict {PACKAGE_PIN Y8 IOSTANDARD LVCMOS33} [get_ports cam_XCLK]
set_property -dict {PACKAGE_PIN W9 IOSTANDARD LVCMOS33} [get_ports cam_RESET]
set_property -dict {PACKAGE_PIN Y9 IOSTANDARD LVCMOS33} [get_ports cam_SIOC]
