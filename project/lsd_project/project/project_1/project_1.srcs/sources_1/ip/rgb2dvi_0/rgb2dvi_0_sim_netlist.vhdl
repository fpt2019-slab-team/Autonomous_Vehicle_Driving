...
entity rgb2dvi_0_ClockGen is
  port (
    ...
    pLockGained_reg_0 : out STD_LOGIC;
    in0 : out STD_LOGIC;
    aRst : in STD_LOGIC;
    PixelClk : in STD_LOGIC
  );
...
entity rgb2dvi_0_rgb2dvi is
  ...
  attribute kClkRange of rgb2dvi_0_rgb2dvi : entity is 5;
...
architecture STRUCTURE of rgb2dvi_0 is
  ...
  attribute kClkRange : integer;
  attribute kClkRange of U0 : label is 5;
  attribute kClkSwap : string;
  ...
  attribute x_interface_parameter of TMDS_Clk_n : signal is "XIL_INTERFACENAME TMDS_Clk_n, ASSOCIATED_RESET aRst_n:AsyncRst_n, FREQ_HZ 100000000, PHASE 0.000, INSERT_VIP 0";
