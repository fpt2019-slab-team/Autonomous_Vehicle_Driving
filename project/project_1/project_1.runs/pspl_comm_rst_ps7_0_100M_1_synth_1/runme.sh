...
HD_PWD='/home/users/matsuda/project/Autonomous_Vehicle_Driving/project/project_1/project_1.runs/pspl_comm_rst_ps7_0_100M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pspl_comm_rst_ps7_0_100M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pspl_comm_rst_ps7_0_100M_1.tcl
