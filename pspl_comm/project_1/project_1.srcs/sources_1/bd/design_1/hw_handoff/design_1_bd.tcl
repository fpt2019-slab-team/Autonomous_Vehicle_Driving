...
proc create_root_design { parentCell } {
  ...
  set pulse1 [ create_bd_port -dir O pulse1 ]
  set pulse2 [ create_bd_port -dir O pulse2 ]
  set sw [ create_bd_port -dir I -from 1 -to 0 sw ]

  # Create instance: myip_0, and set properties
  set myip_0 [ create_bd_cell -type ip -vlnv pcalab:user:myip:1.0 myip_0 ]
  ...
  connect_bd_net -net myip_0_led_out [get_bd_ports led_out] [get_bd_pins myip_0/led_out]
  connect_bd_net -net myip_0_pulse1 [get_bd_ports pulse1] [get_bd_pins myip_0/pulse1]
  connect_bd_net -net myip_0_pulse2 [get_bd_ports pulse2] [get_bd_pins myip_0/pulse2]
  ...
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins myip_0/sw]
