...
class Driver:
	...
	def __init__(
		...
		VEHICLE_REAR_CAMERA_DR  = np.pi, # [rad]
		# VEHICLE }
		...
		if IS_KALMAN:
			...
			KALMAN_FRONT_CAMERA_POS = np.array([[VEHICLE_FRONT_CAMERA_DX], [VEHICLE_FRONT_CAMERA_DY], [VEHICLE_FRONT_CAMERA_DZ]])
			KALMAN_REAR_CAMERA_POS  = np.array([ [VEHICLE_REAR_CAMERA_DX],  [VEHICLE_REAR_CAMERA_DY],  [VEHICLE_REAR_CAMERA_DZ]])
